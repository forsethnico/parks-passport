...
describe("Search Form", () => {
  ...
  it("should have be able to type in a search query and see park cards display once search is submitted", () => {
    ...
    cy.get('[href="/parks/anti"] > .park-card').contains('h2', 'Antietam')
    .get('[href="/parks/anti"] > .park-card > .park-image').should('have.attr', 'src', 'https://www.nps.gov/common/uploads/structured_data/3C80828B-1DD8-B71B-0BAC8994DD862724.jpg')
  });
...
describe("Home Page Errors", () => {
  ...
  it("should display a message to the user when the server is down to retrieve search results info", () => {
    ...
    cy.get(".error-message").contains("500:Internal Server Error- sorry try again!");
  });
});
